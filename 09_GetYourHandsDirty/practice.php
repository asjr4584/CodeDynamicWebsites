<?php
	...
	// Constants
	define("TITLE", "Allan's Different Types of Arrays");
	...
	<body>
		<div class="wrapper">
			...
			<div class="sandbox">
				...
				<p><strong><?php echo $gentlemen[1]["first_name"]; ?></strong> is a rather dapper <strong><?php echo $age_group[1]; ?></strong>! He proudly wears a <strong><?php echo $fu_machu["name"]; ?></strong> that is coloured a gentle <strong><?php echo $fu_machu["colour"]; ?></strong>.</p>
